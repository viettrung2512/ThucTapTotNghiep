                ...
                <div className="flex-grow text-center md:text-left">
                  ...
                  <div className="mt-8 flex justify-center md:justify-start space-x-12">
                    ...
                    <div className="flex flex-col items-center md:items-start group">
                      <span className="text-3xl font-bold text-gray-900">{myPosts.length || 0}</span>
            ...
            <>
              {loading ? (
                <div className="flex justify-center items-center my-16">
                  ...
                  <p className="ml-4 text-gray-600 text-lg font-medium">Loading posts...</p>
                </div>
              ) : myPosts.length > 0 ? (
                ...
                <div className="bg-white rounded-xl shadow-md p-12 text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    {user?.name || "This user"} hasnt published any posts yet. Check back later for new content.
                  </p>
                  <Link
                    to="/"
              ...
              <div className="space-y-6">
                {myPosts.length > 0 ? (
                    ...
                    <div key={post.id || index} className="flex">
                      ...
                      <div className="flex-grow pb-6">
                        <div className="flex items-center mb-1">
                          <h4 className="text-lg font-medium text-gray-900">Published a new post</h4>
                        ...
                        >
                          <p className="font-medium text-purple-600">{post.title}</p>
                  ...
                  <div className="text-center py-8">
                    ...
                    <h4 className="text-xl font-medium text-gray-800 mb-2">No activity yet</h4>
                    <p className="text-gray-600">
                      When {user?.name || "this user"} interacts with posts or publishes content, it will appear here.
                    </p>
                  </div>
                )}
              </div>
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-500 px-6 py-4 text-white">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold flex items-center">
              {title === "Followers" ? <Users className="h-5 w-5 mr-2" /> : <UserPlus className="h-5 w-5 mr-2" />}
              {title}
            </h2>
            <button
        ...
        <div className="overflow-y-auto flex-grow p-4">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">No {title.toLowerCase()} yet</h3>
